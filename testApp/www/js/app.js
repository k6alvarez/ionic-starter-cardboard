...
.directive('cardboardGl', [function() {
  ...
  function create(glFrame) {
    var scene,
        ...
        cities = [['Sydney', '2147714'], ['Atlanta', '4180439']];
        cityWeather = {},
        cityTimes = [],
        currentCity = 0,
    ...
    function adjustToWeatherConditions() {
      ...
      // getURL('http://api.openweathermap.org/data/2.5/group?id=' + cityIDs + '&APPID=6f4e9571b6dd2f3d890ece856118ef40', function(info) {
